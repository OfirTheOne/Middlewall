...
export function isJson(path: string, ifPass?: IfPassFn, error?: ErrorConstructor | string): BrickFn {
...
export function isAlpha(path: string, ifPass?: IfPassFn, error?: ErrorConstructor | string): BrickFn {
...
export function isAlphaNumeric(path: string, ifPass?: IfPassFn, error?: ErrorConstructor | string): BrickFn {
